...
### 3 Install requirements (There are a lot, but they are needed. See requirements.in for intended packages)
```bash
...
### 5 Run the app (it should open automatically or see the terminal for the url)
```bash
